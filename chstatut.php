...
//session_start();
	...
	if($_SESSION['statut'] <5 || $_SESSION['modesystem']==0){
		echo("<h2>Non autoris√© : en maintenance ou statut insuffisant</h2>");
...
<?php
	...
	/* On rÈcupËre si elle existe la valeur de l'utilisateur envoyÈe par le formulaire */
...
<?php
	echo("<?xml version=\"1.0\" encoding=\"iso-8859-1\"?>\n");
	/* On rÈcupËre si elle existe la valeur du statut envoyÈe par le formulaire */
			...
			<select name="id_utilisateur" id="id_utilisateur" onchange="document.forms['chg'].submit();">
		        ...
		        <?php
					...
					while($ligne=mysqli_fetch_assoc($result)) {
						...
						// astuce pour conserver le choix quand la page est reactualisÈe
